...
* This class is used to create an object for base currency adjustment list.

*/

public class BaseCurrencyAdjustmentList extends ArrayList<BaseCurrencyAdjustment>
{
