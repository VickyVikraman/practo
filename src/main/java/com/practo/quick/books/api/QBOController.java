package com.practo.quick.books.api;
...
import com.practo.quick.books.service.QBOServiceHelper;
...
public class QBOController {
    ...
    public String callQBOCompanyInfo(HttpSession session) throws JSONException {
	...
	private String processResponse(String failureMsg, QueryResult queryResult) throws JSONException {
